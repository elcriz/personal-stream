...
import { ISerializedHike } from 'src/services/hikes/hikesService';

interface HikesOverviewProps {
  hikes: ISerializedHike[];
  month?: number;
  year: number;
  amount: number;
  onAddClick: () => void;
  onFetch: (sortBy: string, isAscending: boolean) => void;
  isFirstUpdate: boolean;
  isAddingDisabled: boolean;
  isLoading: boolean;
}

function HikesOverview({
  hikes,
  month,
  year,
  amount,
